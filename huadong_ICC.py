...
# img2 = cv2.imread('/Users/sonny_he/Desktop/opencv_learning/13409.png', cv2.IMREAD_GRAYSCALE)
...
for i in range(n_blocks_h):
    for j in range(n_blocks_w):
        ...
        # similarity[i, j] = compare_ssim(block1[0], block2[0])
        # hist1 = cv2.calcHist([block1], [0], None, [8], [0, 256])
        # hist2 = cv2.calcHist([block2], [0], None, [8], [0, 256])
...
# cv2.imwrite("result_ssim.jpg",img3)
