...
img=cv2.imread('te.jpg', cv2.IMREAD_GRAYSCALE)
img0 = cv2.imread('te.jpg', cv2.IMREAD_COLOR)
...
lines = cv2.HoughLinesP(masked_edge_img, 1, np.pi/180, 15, minLineLength=10, maxLineGap=10)
